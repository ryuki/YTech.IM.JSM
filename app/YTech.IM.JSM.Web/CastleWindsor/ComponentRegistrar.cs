...
namespace YTech.IM.JSM.Web.CastleWindsor
{
    public class ComponentRegistrar
    {
        ...
        private static void AddApplicationServicesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                .FromAssemblyNamed("YTech.IM.JSM.ApplicationServices")
                .Pick()
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                .FromAssemblyNamed("YTech.IM.JSM.Data")
                .Pick()
                .WithService.FirstNonGenericCoreInterface("YTech.IM.JSM.Core"));
        }
